...
- Unframed-edge count draws from two separate sources, not one:
...
| `unframedEdgeCount` | Combines `sash*Locked` flags (Case 2) AND meeting-jamb-touching geometry (Case 1) — see above. |
