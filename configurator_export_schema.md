...
Status: built (v1 in batch 29, v2/v3 in batches 39/43, v4 in batch 44, corrected batches 45/46) — this document now describes the actual, current export shape, not a design-only proposal.
